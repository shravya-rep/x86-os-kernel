...
(A.1) In fs/vn_special.c:
    (a) In special_file_read(): 3 out of 3 pts
    (b) In special_file_write(): 3 out of 3 pts
...
(C.1) faber_fs_thread_test (6 out of 6 pts)
    What is your kshell command to invoke faber_fs_thread_test(): faberfs
(C.2) faber_directory_test (4 out of 4 pts)
    What is your kshell command to invoke faber_directory_test(): faberdir
...
1)  Names and USC e-mail addresses of team members: 
	Lex Lachica llachica@usc.edu 
	Shravya Shashidhar sshashid@usc.edu 
	Tianyang Li litianya@usc.edu 
