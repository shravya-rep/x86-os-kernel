...
(D.2) /usr/bin/memtest (4 out of 6 pts)
(D.3) /usr/bin/eatmem (6 out of 6 pts)
(D.4) /usr/bin/forkbomb (3 out of 6 pts)
(D.5) /usr/bin/stress (3 out of 6 pts)
...
Please skip the following tests: Dont run "forkbomb" and "stress"

+--------------------------------------------------------------------------------------------+
| ADDITIONAL INFORMATION FOR GRADER (Optional, but the grader should read what you add here) |
+--------------------------------------------------------------------------------------------+
Please still run "forkbomb limit250" and "stress limit250" 
+-----------------------------------------------+
