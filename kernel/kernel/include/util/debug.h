...
static int equals(int l, int r) { return l == r; }
static int notequals(int l, int r) { return l != r; }
static int lessthan(int l, int r) { return l < r; }
static int greaterthan(int l, int r) { return l > r; }
static int lessthaneq(int l, int r) { return l <= r; }
static int greaterthaneq(int l, int r) { return l >= r; }
